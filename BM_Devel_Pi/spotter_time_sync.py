...
# Sprint26 S1: one codec (bm_codec); these names stay for existing callers
# (command_daemon imports _build_subscribe_frame from here).
_crc = bm_codec.crc16
_cobs_encode = bm_codec.cobs_encode
_finalize_packet = bm_codec.finalize_packet
